...
public class Config {
    ...
    public static boolean DEBUG_PARSER1 = true;                 // Enable for the debugging messages specified in the project report
    ...
    public static String GRAMMAR_PATH = "grammar.txt";          // Specify the grammar file path
