...
public class MIPSGenVisitor implements IRVisitor {
	...
	public void visit(add i) {
		...
		if ((i.left instanceof NamedVar || i.left instanceof TempVar)&& (i.right instanceof NamedVar) || i.right instanceof TempVar) {
		...
		} else if ((i.left instanceof NamedVar)
				|| ((i.left instanceof TempVar)) && !(i.right instanceof NamedVar)) { // left is a variable

			emit(new AssemblyHelper("lw", "$t0", i.left.toString(), ""));
			emit(new AssemblyHelper("add ", "$t0", "$t0", i.right.toString()));

		} else if (!(i.left instanceof NamedVar)
				&& ((i.right instanceof NamedVar) || ((i.right instanceof TempVar)))) { // right is a variable
	...
	public void visit(sub i) {
		// both variables
		if ((i.left instanceof NamedVar || i.left instanceof TempVar)
				&& (i.right instanceof NamedVar || i.right instanceof TempVar)) {
			emit(new AssemblyHelper("lw", "$t0", i.left.toString(), ""));
			emit(new AssemblyHelper("lw", "$t1", i.right.toString(), ""));
	...
	public void visit(and i) {
		if ((i.left instanceof NamedVar) || (i.left instanceof TempVar)
				&& ((i.right instanceof NamedVar) || (i.right instanceof TempVar))) {// both variables
			emit(new AssemblyHelper("lw", "$t0", i.left.toString(), ""));
			emit(new AssemblyHelper("lw", "$t1", i.right.toString(), ""));
	...
	public void visit(assign i) {
		...
		if (i.right instanceof NamedVar || i.right instanceof TempVar) { // right is a variable
	...
	public void visit(array_load i) {
		// TODO Auto-generated method stub
		if (i.index instanceof NamedVar) { // index is a variable
	...
	public void visit(array_store i) {
		// TODO Auto-generated method stub
		if ((i.index instanceof NamedVar) && (i.right instanceof NamedVar)) { // both variables
			emit(new AssemblyHelper("lw", "$t1", i.index.toString(), ""));
			emit(new AssemblyHelper("lw", "$t2", i.right.toString(), ""));
		} else if (!(i.index instanceof NamedVar) && (i.right instanceof NamedVar)) { // right is a variable
			emit(new AssemblyHelper("add", "$t1", "$zero", i.index.toString()));
			emit(new AssemblyHelper("lw", "$t2", i.right.toString(), ""));
		} else if ((i.index instanceof NamedVar) && !(i.right instanceof NamedVar)) { // index variables
			emit(new AssemblyHelper("lw", "$t1", i.index.toString(), ""));
	...
	public void visit(breq i) {
		...
		} else if ((i.left instanceof NamedVar || i.left instanceof TempVar)
				&& !(i.right instanceof NamedVar)) { // left is a variable
			emit(new AssemblyHelper("lw", "$t0", i.left.toString(), ""));
	...
	public void visit(brneq i) {
		...
		} else if (!(i.left instanceof NamedVar) && (i.right instanceof NamedVar||i.right instanceof TempVar)) { //right is a variable
			emit(new AssemblyHelper("lw", "$t0", i.right.toString(), ""));
			emit(new AssemblyHelper("brgeq", i.left.toString(), "$t0", i.labelOp.toString()));
		} else if ((i.left instanceof NamedVar||i.left instanceof TempVar) && !(i.right instanceof NamedVar)) { //left is a variable
			emit(new AssemblyHelper("lw", "$t0", i.left.toString(), ""));
